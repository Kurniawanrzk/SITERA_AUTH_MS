...
Route::prefix('v1/auth')->group(function(){
    ...
    Route::get("/update-status-user/{userId}/{nomorTelepon}/{status}/{alasanDiTolak}", [App\Http\Controllers\API\SuperadminController::class, 'updateStatusUser'])->middleware('auth:api');
